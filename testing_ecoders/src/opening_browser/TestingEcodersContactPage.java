...
public static void main(String[] args) throws Throwable {
	...
	if (expectedtitle.equals(titleofpage)) {
		System.out.println("Title matched contact page case passed");
	}else {
		System.out.println("Title did not match,contact page case passed.");
	}
	if (expectedurl.equals(urlofpage)) {
		System.out.println("Url matched contact page case passed");
	}else {
		System.out.println("Url did not match,contact page case passed.");
	}
	driver.quit();
